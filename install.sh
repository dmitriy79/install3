...
################################################################################
    ...
    php7.2-cgi php-pear php-auth-sasl imagemagick libruby php7.2-curl php7.2-intl php7.2-pspell mcrypt\
    php7.2-recode php7.2-sqlite3 php7.2-tidy php7.2-xmlrpc php7.2-xsl memcached php7.2-memcache php-imagick php-gettext php7.2-zip php7.2-mbstring
