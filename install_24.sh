...
################################################################################
  ...
  #  fi
    ...
    php8.3-cgi php-pear php-auth-sasl imagemagick libruby php8.3-curl php8.3-intl php8.3-pspell mcrypt\
    php8.3-sqlite3 php8.3-tidy php8.3-xmlrpc php8.3-xsl memcached php8.3-memcache php-imagick php8.3-zip php8.3-mbstring
    sudo phpenmod mcrypt
    sudo phpenmod mbstring
    sudo apt -y install php8.3-fpm php8.3-opcache php8.3 php8.3-common php8.3-gd php8.3-mysql php8.3-imap php8.3-cli \
    php8.3-cgi php-pear imagemagick libruby php8.3-curl php8.3-intl php8.3-pspell mcrypt\
    php8.3-sqlite3 php8.3-tidy php8.3-xmlrpc php8.3-xsl memcached php8.3-memcache php8.3-memcached php-imagick php8.3-gettext php8.3-zip php8.3-mbstring \
    ...
    # Compil Blocknotify
    cd ~
    git clone https://github.com/dmitriy79/yiimp3.git yiimp
